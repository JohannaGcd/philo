...
/*   Updated: 2025/10/27 10:40:24 by jguacide      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
#define STR_CORRECT_ARGS "warning: wrong \
%s arguments: ./philo <number_of_philosophers > \
<time_to_die> <time_to_eat> <time_to_sleep> \
[number_of_times_each_philosopher_must_eat]\n"
#define STR_PROG_NAME "philo"
#define STR_ERR_DIGITS_ONLY "%s invalid input: \
%s should be a positive integer between 0 and INT_MAX, ie. 2147483647.\n"
#define STR_ERR_MAX_PHILO "%s invalid input: \
there must be between 1 and 200 philsophers at most.\n"
...
int						thread_operator(pthread_t *thread,
							void *(*routine)(void *), void *data,
							t_thread_operation operation);
int						mutex_operator(pthread_mutex_t *mutex,
							t_mutex_operation operation);
time_t					get_time_in_ms(void);
void					*philo_routine(void *data);
void					write_bool(pthread_mutex_t *mutex, bool *dest,
							bool value);
void					write_long(pthread_mutex_t *mutex, long *dest,
							long value);
long					return_long(pthread_mutex_t *mutex, long *value);
void					coordinate_start(time_t start);
void					write_status(t_philo *philo, bool faucheuse_info,
							t_status status);
